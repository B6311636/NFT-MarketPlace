...
const Walletbar: FunctionComponent<WalletbarProps> = ({
    ...
    if (account) {
        const thisaccount = String(account); // Convert accountValue to a string

        const formattedAccount = `0x${thisaccount.substring(2, thisaccount.length - 4)}${thisaccount.slice(-4)}`;
